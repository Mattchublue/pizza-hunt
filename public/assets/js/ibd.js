...
let db;
// establish a connection to IndexedDB database called 'pizza_ hunt' and set it to version 1
...
request.onsuccess = function(event) {
    ...
    if (navigator.onLine) {
        // we haven't created this yet, but we will soon, so let's comment it out for me
        uploadPizza();
    }
};
